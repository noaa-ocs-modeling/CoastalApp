...
! beging -- afm 20210805
   ...
   logical (kind=log_kind) :: use_inflow
! end -- afm 20210805
...
! end -- afm 20210805
	    do n = 1, ncat
            do j = 1, ny_block
            do i = 1, ilo+ ibd -1
               if ( (uvel(ilo-1,j,iblk)+uvel(ilo,j,iblk))*p5 &
                 > c0 ) then ! when inflow
...
! end -- afm 20210805
            ...
            do i = ihi-ibd+1, ibc
            do n = 1, ncat
               if ( (uvel(ihi-1,j,iblk)+uvel(ihi,j,iblk))*p5&
                 < c0 ) then ! when inflow
...
! end -- afm 20210805
            ...
            do j = 1, jlo+ ibd - 1
            do i = 1, nx_block
               if ( (vvel(i,jlo-1,iblk)+vvel(i,jlo,iblk))*p5&
                 > c0 ) then ! when inflow
...
! end -- afm 20210805
  	    ...
  	    do n = 1, ncat
            do j = jhi-ibd+1, ibc
            do i = 1, nx_block
               if ( (vvel(i,jhi-1,iblk)+vvel(i,jhi,iblk))*p5&
                 < c0 ) then ! when inflow
