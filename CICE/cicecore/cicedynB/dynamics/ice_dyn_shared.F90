...
!         k1 = 4.0_dbl_kind , &  ! first free parameter for landfast parametrization             !hhu, Jan 7 2020
!         k1 = 8.0_dbl_kind , &  ! first free parameter for landfast parametrization 
!         k1 = 16.0_dbl_kind , &  ! first free parameter for landfast parametrization             !hhu, Sep 17 2020
         k1 = 10.0_dbl_kind , &  ! first free parameter for landfast parametrization             !hhu, Sep 24 2020
